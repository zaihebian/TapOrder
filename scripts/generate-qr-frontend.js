...
async function generateQRCode() {
  try {
    // Point to frontend with merchant ID as parameter
    const merchantId = 'cmgqv7vbt0003tzkkvu1v0s4v'; // Mario's Pizza Palace
    const url = `http://localhost:3001/menu/${merchantId}`;
    ...
    console.log('4. You should be redirected to the frontend menu page');
